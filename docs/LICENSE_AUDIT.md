...
- Collections audited: 65
- License buckets: AGPL-3.0=1, Apache-2.0=1, CC-BY-NC-4.0 (non-commercial)=1, CC-BY-SA-4.0 (repository default)=4, MIT=34, MIT Non-Commercial=1, UNKNOWN - check upstream=23
- Commercial-use buckets: allowed=35, restricted=2, share-alike=5, unknown=23
- Source-confidence buckets: high=37, low=7, medium=17, unresolved=4
